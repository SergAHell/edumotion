...
namespace ANT_Managed_Library
{
  ...
  public class ANT_Device : IDisposable
  {
    ...
    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_SetNetworkKey_RTO", CallingConvention = CallingConvention.Cdecl)]
    private extern static int ANT_SetNetworkKey(IntPtr FramerPtr, byte ucNetNumber, byte[] pucKey, uint ulResponseTime_);

    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_EnableLED_RTO", CallingConvention = CallingConvention.Cdecl)]
    private extern static int ANT_EnableLED(IntPtr FramerPtr, byte ucEnable, uint ulResponseTime_);

    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_SetUSBDescriptorString_RTO", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_ConfigureAdvancedBurst_RTO", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_ConfigureAdvancedBurst_ext_RTO", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_SetTransmitPower_RTO", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_InitCWTestMode_RTO", CallingConvention = CallingConvention.Cdecl)]
    private extern static int ANT_InitCWTestMode(IntPtr FramerPtr, uint ulResponseTime_);

    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_SetCWTestMode_RTO", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_OpenRxScanMode_RTO", CallingConvention = CallingConvention.Cdecl)]
    private extern static int ANT_OpenRxScanMode(IntPtr FramerPtr, uint ulResponseTime_);

    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_Script_Write_RTO", CallingConvention = CallingConvention.Cdecl)]
    private extern static int ANT_Script_Write(IntPtr FramerPtr, byte ucSize_, byte[] pucData_, uint ulResponseTime_);

    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_Script_Clear_RTO", CallingConvention = CallingConvention.Cdecl)]
    private extern static int ANT_Script_Clear(IntPtr FramerPtr, uint ulResponseTime_);

    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_Script_SetDefaultSector_RTO", CallingConvention = CallingConvention.Cdecl)]
    private extern static int ANT_Script_SetDefaultSector(IntPtr FramerPtr, byte ucSectNumber_, uint ulResponseTime_);

    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_Script_EndSector_RTO", CallingConvention = CallingConvention.Cdecl)]
    private extern static int ANT_Script_EndSector(IntPtr FramerPtr, uint ulResponseTime_);

    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_Script_Dump_RTO", CallingConvention = CallingConvention.Cdecl)]
    private extern static int ANT_Script_Dump(IntPtr FramerPtr, uint ulResponseTime_);

    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_Script_Lock_RTO", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("ANT_WrappedLib.dll", EntryPoint = "ANT_RxExtMesgsEnable_RTO", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("ANT_WrappedLib.dll", EntryPoint = "FIT_SetFEState_RTO", CallingConvention = CallingConvention.Cdecl)]
    private extern static int FIT_SetFEState(IntPtr FramerPtr, byte ucFEState_, uint ulResponseTime_);

    [DllImport("ANT_WrappedLib.dll", EntryPoint = "FIT_AdjustPairingSettings_RTO", CallingConvention = CallingConvention.Cdecl)]
